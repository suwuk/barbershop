                ...
                <tbody>
                    <tr class="text-center">
                        ...
                        <td>
                            ...
                            <a href ="<?= base_url('admin/delete_member/' . $usr->id) ?>" class= "btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin menghapus data ini?')"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                </tbody>
            <?php endforeach?>
